...
1. [Data Science Python - Getting Started](#data-science-python---getting-started)
2. [Python Data Science - Environment Setup](#python-data-science---environment-setup)
3. [Python Data Science - Pandas](#python-data-science---pandas)
4. [Python Data Science - NumPy](#python-data-science---numpy)
5. [Python Data Science - SciPy](#python-data-science---scipy)
6. [Python Data Science - Matplotlib](#python-data-science---matplotlib)
7. [Python - Data Operations](#python---data-operations)
8. [Python - Data Cleansing](#python---data-cleansing)
9. [Python - Processing CSV Data](#python---processing-csv-data)
10. [Python - Processing JSON Data](#python---processing-json-data)
11. [Python - Processing XLS Data](#python---processing-xls-data)
12. [Python - Relational Databases](#python---relational-databases)
13. [Python - NoSQL Databases](#python---nosql-databases)
14. [Python - Date and Time](#python---date-and-time)
15. [Python - Data Wrangling](#python---data-wrangling)
16. [Python - Data Aggregation](#python---data-aggregation)
17. [Python - Reading HTML Pages](#python---reading-html-pages)
18. [Python - Processing Unstructured Data](#python---processing-unstructured-data)
19. [Python - Word Tokenization](#python---word-tokenization)
20. [Python - Stemming and Lemmatization](#python---stemming-and-lemmatization)
21. [Python - Chart Properties](#python---chart-properties)
22. [Python - Chart Styling](#python---chart-styling)
23. [Python - Box Plots](#python---box-plots)
24. [Python - Heat Maps](#python---heat-maps)
25. [Python - Scatter Plots](#python---scatter-plots)
26. [Python - Bubble Charts](#python---bubble-charts)
27. [Python - 3D Charts](#python---3d-charts)
28. [Python - Time Series](#python---time-series)
29. [Python - Geographical Data](#python---geographical-data)
30. [Python - Graph Data](#python---graph-data)
31. [Python - Measuring Central Tendency](#python---measuring-central-tendency)
32. [Python - Measuring Variance](#python---measuring-variance)
33. [Python - Normal Distribution](#python---normal-distribution)
34. [Python - Binomial Distribution](#python---binomial-distribution)
35. [Python - Poisson Distribution](#python---poisson-distribution)
36. [Python - Bernoulli Distribution](#python---bernoulli-distribution)
37. [Python - P-Value](#python---p-value)
38. [Python - Correlation](#python---correlation)
39. [Python - Chi-Square Test](#python---chi-square-test)
40. [Python - Linear Regression](#python---linear-regression)

---

## 1. Data Science Python - Getting Started

*Source: [https://www.tutorialspoint.com/python_data_science/python_data_science_introduction.htm](https://www.tutorialspoint.com/python_data_science/python_data_science_introduction.htm)*

---

---
[Previous](/python_data_science/index.htm)[Quiz](/python_data_science/quiz_on_python_data_science_introduction.htm)[Next](/python_data_science/python_data_science_environment_setup.htm)
...
## 2. Python Data Science - Environment Setup

*Source: [https://www.tutorialspoint.com/python_data_science/python_data_science_environment_setup.htm](https://www.tutorialspoint.com/python_data_science/python_data_science_environment_setup.htm)*

---

---
[Previous](/python_data_science/python_data_science_introduction.htm)[Quiz](/python_data_science/quiz_on_python_data_science_environment_setup.htm)[Next](/python_data_science/python_pandas.htm)
...
Anaconda (from
[www.continuum.io](https://www.continuum.io)) is a free Python distribution for SciPy stack. It is also available for Linux and Mac.
Canopy (
[www.enthought.com/products/canopy/](https://www.enthought.com/products/canopy/)) is available as free as well as commercial distribution with full SciPy stack for Windows, Linux and Mac.
Python (x,y): It is a free Python distribution with SciPy stack and Spyder IDE for Windows OS. (Downloadable from
[www.python-xy.github.io/](https://python-xy.github.io/))
## Linux
...
## 3. Python Data Science - Pandas

*Source: [https://www.tutorialspoint.com/python_data_science/python_pandas.htm](https://www.tutorialspoint.com/python_data_science/python_pandas.htm)*

---

---
[Previous](/python_data_science/python_data_science_environment_setup.htm)[Quiz](/python_data_science/quiz_on_python_pandas.htm)[Next](/python_data_science/python_numpy.htm)
## What is Pandas?
...
Data StructureDimensionsDescriptionSeries11D labeled homogeneous array, size-immutable.Data Frames2General 2D labeled, size-mutable tabular structure with potentially heterogeneously typed columns.
...
## 4. Python Data Science - NumPy

*Source: [https://www.tutorialspoint.com/python_data_science/python_numpy.htm](https://www.tutorialspoint.com/python_data_science/python_numpy.htm)*

---

---
[Previous](/python_data_science/python_pandas.htm)[Quiz](/python_data_science/quiz_on_python_numpy.htm)[Next](/python_data_science/python_scipy.htm)
## What is NumPy?
...
**ndarray**. It describes the collection of items of the same type. Items in the collection can be accessed using a zero-based index.
...
## 5. Python Data Science - SciPy

*Source: [https://www.tutorialspoint.com/python_data_science/python_scipy.htm](https://www.tutorialspoint.com/python_data_science/python_scipy.htm)*

---

---
[Previous](/python_data_science/python_numpy.htm)[Quiz](/python_data_science/quiz_on_python_scipy.htm)[Next](/python_data_science/python_matplotlib.htm)
## What is SciPy?
...
[scipy.constants](https://docs.scipy.org/doc/scipy/reference/constants.html#module-scipy.constants)Physical and mathematical constants[scipy.fftpack](https://docs.scipy.org/doc/scipy/reference/fftpack.html#module-scipy.fftpack)Fourier transform[scipy.integrate](https://docs.scipy.org/doc/scipy/reference/integrate.html#module-scipy.integrate)Integration routines[scipy.interpolate](https://docs.scipy.org/doc/scipy/reference/interpolate.html#module-scipy.interpolate)Interpolation[scipy.io](https://docs.scipy.org/doc/scipy/reference/io.html#module-scipy.io)Data input and output[scipy.linalg](https://docs.scipy.org/doc/scipy/reference/linalg.html#module-scipy.linalg)Linear algebra routines[scipy.optimize](https://docs.scipy.org/doc/scipy/reference/optimize.html#module-scipy.optimize)Optimization[scipy.signal](https://docs.scipy.org/doc/scipy/reference/signal.html#module-scipy.signal)Signal processing[scipy.sparse](https://docs.scipy.org/doc/scipy/reference/sparse.html#module-scipy.sparse)Sparse matrices[scipy.spatial](https://docs.scipy.org/doc/scipy/reference/spatial.html#module-scipy.spatial)Spatial data structures and algorithms[scipy.special](https://docs.scipy.org/doc/scipy/reference/special.html#module-scipy.special)Any special mathematical functions[scipy.stats](https://docs.scipy.org/doc/scipy/reference/stats.html#module-scipy.stats)Statistics
## Data Structure
...
## 6. Python Data Science - Matplotlib

*Source: [https://www.tutorialspoint.com/python_data_science/python_matplotlib.htm](https://www.tutorialspoint.com/python_data_science/python_matplotlib.htm)*

---

---
[Previous](/python_data_science/python_scipy.htm)[Quiz](/python_data_science/quiz_on_python_matplotlib.htm)[Next](/python_data_science/python_data_operations.htm)
## What is Matplotlib?
...
The following script produces the
...
Its
**output**is as follows −![Sine Wave](/numpy/images/sine_wave.jpg)
We will see lots of examples on using Matplotlib library of python in Data science work in the next chapters.

---

## 7. Python - Data Operations

*Source: [https://www.tutorialspoint.com/python_data_science/python_data_operations.htm](https://www.tutorialspoint.com/python_data_science/python_data_operations.htm)*

---

---
[Previous](/python_data_science/python_matplotlib.htm)[Quiz](/python_data_science/quiz_on_python_data_operations.htm)[Next](/python_data_science/python_data_cleansing.htm)
...
**Series**,**Data Frame**, and**Panel**. We will see some examples from each of these.
## Pandas Series
...
## 8. Python - Data Cleansing

*Source: [https://www.tutorialspoint.com/python_data_science/python_data_cleansing.htm](https://www.tutorialspoint.com/python_data_science/python_data_cleansing.htm)*

---

---
[Previous](/python_data_science/python_data_operations.htm)[Quiz](/python_data_science/quiz_on_python_data_cleansing.htm)[Next](/python_data_science/python_processing_csv_data.htm)
...
MethodActionpad/fillFill methods Forwardbfill/backfillFill methods Backward
### Example
...
If you want to simply exclude the missing values, then use the
**dropna**function along with the**axis**argument. By default, axis=0, i.e., along row, which means that if any value within a row is NA then the whole row is excluded.
### Example
...
## 9. Python - Processing CSV Data

*Source: [https://www.tutorialspoint.com/python_data_science/python_processing_csv_data.htm](https://www.tutorialspoint.com/python_data_science/python_processing_csv_data.htm)*

---

---
[Previous](/python_data_science/python_data_cleansing.htm)[Quiz](/python_data_science/quiz_on_python_processing_csv_data.htm)[Next](/python_data_science/python_processing_json_data.htm)
...
The
**read_csv**function of the pandas library is used read the content of a CSV file into the python environment as a pandas DataFrame. The function can read the files from the OS by using proper path to the file.
```
import pandas as pd
...
The
**read_csv**function of the pandas library can also be used to read some specific rows for a given column. We slice the result from the read_csv function using the code shown below for first 5 rows for the column named salary.
```
import pandas as pd
data = pd.read_csv('path/input.csv')
...
The
**read_csv**function of the pandas library can also be used to read some specific columns. 
...
The
**read_csv**function of the pandas library can also be used to read some specific columns and specific rows. 
...
The
**read_csv**function of the pandas library can also be used to read some specific columns and a range of rows. 
We use the multi-axes indexing method called**.loc()**for this purpose. We choose to display the salary and name column for some of the rows.
```
import pandas as pd
data = pd.read_csv('path/input.csv')
...
## 10. Python - Processing JSON Data

*Source: [https://www.tutorialspoint.com/python_data_science/python_processing_json_data.htm](https://www.tutorialspoint.com/python_data_science/python_processing_json_data.htm)*

---

---

## 11. Python - Processing XLS Data

*Source: [https://www.tutorialspoint.com/python_data_science/python_processing_xls_data.htm](https://www.tutorialspoint.com/python_data_science/python_processing_xls_data.htm)*

---

---
[Previous](/python_data_science/python_processing_json_data.htm)[Quiz](/python_data_science/quiz_on_python_processing_xls_data.htm)[Next](/python_data_science/python_relational_databases.htm)
...
The Panadas library provides features using which we can read the Excel file in full as well as in parts for only a selected group of Data. We can also read an Excel file with multiple sheets in it. We use the
**read_excel**function to read the data from it.
## Input as Excel File

We Create an excel file with multiple sheets in the windows OS. The Data in the different sheets is as shown below.

You can create this file using the Excel Program in windows  OS. Save the file as
**input.xlsx**.
```
# Data in Sheet1
...
The
**read_excel**function of the pandas library is used read the content of an Excel file into the python environment as a pandas DataFrame. The function can read the files from the OS by using proper path to the file. By default, the function will read Sheet1.
```
import pandas as pd
...
Similar to what we have already seen in the previous chapter to read the CSV file, the
**read_excel**function of the pandas library can also be used to read some specific columns and specific rows. 
We use the multi-axes indexing method called**.loc()**for this purpose. We choose to display the salary and name column for some of the rows.
```
import pandas as pd
data = pd.read_excel('path/input.xlsx')
...
Multiple sheets with different Data formats can also be read by using read_excel function with help of a wrapper class named
**ExcelFile**. It will read the multiple sheets into memory only once. 
...
## 12. Python - Relational Databases

*Source: [https://www.tutorialspoint.com/python_data_science/python_relational_databases.htm](https://www.tutorialspoint.com/python_data_science/python_relational_databases.htm)*

---

---
[Previous](/python_data_science/python_processing_xls_data.htm)[Quiz](/python_data_science/quiz_on_python_relational_databases.htm)[Next](/python_data_science/python_nosql_databases.htm)
We can connect to relational databases for analysing data using the
**pandas**library as well as another additional library for implementing database connectivity.
...
[Data Science Environment](https://www.tutorialspoint.com/python_data_science/python_data_science_environment_setup.htm). Assuming you have installed Anaconda as described in this chapter,
...
We first create a database engine and then connect to the database engine using the
**to_sql**function of the SQLAlchemy library.
In the below example we create the relational table by using the
**to_sql**function from a dataframe already created by reading a csv file.
...
## 13. Python - NoSQL Databases

*Source: [https://www.tutorialspoint.com/python_data_science/python_nosql_databases.htm](https://www.tutorialspoint.com/python_data_science/python_nosql_databases.htm)*

---

---
[Previous](/python_data_science/python_relational_databases.htm)[Quiz](/python_data_science/quiz_on_python_nosql_databases.htm)[Next](/python_data_science/python_date_and_time.htm)
...
In case you are new to MongoDB, you can learn it in our tutorial
[here.](https://www.tutorialspoint.com/mongodb/index.htm)
In order to connect to MongoDB, python uses a library known as
**pymongo**. You can add this library to your python environment, using the below command from the Anaconda environment.
```
...
To insert data into MongoDB we use the insert() method which is available in the database environment. First we connect to the db using python code shown below and then we 
provide the document details in form of a series of key-value pairs.
...
Updating an existing MongoDB data is similar to inserting. We use the update() method which is native to mongoDB. In the below code we are replacing the existing 
record with new key-value pairs. Please note how we are using the condition criteria to decide which record to update.
...
## 14. Python - Date and Time

*Source: [https://www.tutorialspoint.com/python_data_science/python_date_and_time.htm](https://www.tutorialspoint.com/python_data_science/python_date_and_time.htm)*

---

---
[Previous](/python_data_science/python_nosql_databases.htm)[Quiz](/python_data_science/quiz_on_python_date_and_time.htm)[Next](/python_data_science/python_data_wrangling.htm)
Often in data science we need analysis which is based on temporal values. Python can handle the various formats of date and time gracefully. The
**datetime**library 
...
## 15. Python - Data Wrangling

*Source: [https://www.tutorialspoint.com/python_data_science/python_data_wrangling.htm](https://www.tutorialspoint.com/python_data_science/python_data_wrangling.htm)*

---

---
[Previous](/python_data_science/python_date_and_time.htm)[Quiz](/python_data_science/quiz_on_python_data_wrangling.htm)[Next](/python_data_science/python_data_aggregation.htm)
...
The Pandas library in python provides a single function,
**merge**, as the entry point for all standard database join operations between DataFrame objects −
```
...
**Series, DataFrame**, and**Panel**objects. In the below example
...
## 16. Python - Data Aggregation

*Source: [https://www.tutorialspoint.com/python_data_science/python_data_aggregation.htm](https://www.tutorialspoint.com/python_data_science/python_data_aggregation.htm)*

---

---

## 17. Python - Reading HTML Pages

*Source: [https://www.tutorialspoint.com/python_data_science/python_reading_html_pages.htm](https://www.tutorialspoint.com/python_data_science/python_reading_html_pages.htm)*

---

---
[Previous](/python_data_science/python_data_aggregation.htm)[Quiz](/python_data_science/quiz_on_python_reading_html_pages.htm)[Next](/python_data_science/python_processing_unstructured_data.htm)
...
In the below example we make a request to an url to be loaded into the python environment. Then use the html parser parameter to
read the entire html file. Next, we print first few lines of the html page.
...
## 18. Python - Processing Unstructured Data

*Source: [https://www.tutorialspoint.com/python_data_science/python_processing_unstructured_data.htm](https://www.tutorialspoint.com/python_data_science/python_processing_unstructured_data.htm)*

---

---
[Previous](/python_data_science/python_reading_html_pages.htm)[Quiz](/python_data_science/quiz_on_python_processing_unstructured_data.htm)[Next](/python_data_science/python_word_tokenization.htm)
...
## 19. Python - Word Tokenization

*Source: [https://www.tutorialspoint.com/python_data_science/python_word_tokenization.htm](https://www.tutorialspoint.com/python_data_science/python_word_tokenization.htm)*

---

---
[Previous](/python_data_science/python_processing_unstructured_data.htm)[Quiz](/python_data_science/quiz_on_python_word_tokenization.htm)[Next](/python_data_science/python_stemming_and_lemmatization.htm)
...
Next we use the
**word_tokenize**method to split the paragraph into individual words.
```
import nltk
...
We can also tokenize the sentences in a paragraph like we tokenized the words. We use the method
**sent_tokenize**to achieve this. Below is an example.
```
import nltk
...
## 20. Python - Stemming and Lemmatization

*Source: [https://www.tutorialspoint.com/python_data_science/python_stemming_and_lemmatization.htm](https://www.tutorialspoint.com/python_data_science/python_stemming_and_lemmatization.htm)*

---

---
[Previous](/python_data_science/python_word_tokenization.htm)[Quiz](/python_data_science/quiz_on_python_stemming_and_lemmatization.htm)[Next](/python_data_science/python_chart_properties.htm)
...
## 21. Python - Chart Properties

*Source: [https://www.tutorialspoint.com/python_data_science/python_chart_properties.htm](https://www.tutorialspoint.com/python_data_science/python_chart_properties.htm)*

---

---
[Previous](/python_data_science/python_stemming_and_lemmatization.htm)[Quiz](/python_data_science/quiz_on_python_chart_properties.htm)[Next](/python_data_science/python_chart_styling.htm)
Python has excellent libraries for data visualization. A combination of
**Pandas**,**numpy**and**matplotlib**can help in creating in nearly all types of visualizations charts. In this chapter we will get started with looking at some simple chart and the various properties of the chart.
## Creating a Chart
...
Its
**output**is as follows −![chartprop1.png](/python/images/chartprop1.png)
## Labling the Axes
...
Its
**output**is as follows −![chartprop2.png](/python/images/chartprop2.png)
...
Its
**output**is as follows −![chartprop3.png](/python/images/chartprop3.png)
...
## 22. Python - Chart Styling

*Source: [https://www.tutorialspoint.com/python_data_science/python_chart_styling.htm](https://www.tutorialspoint.com/python_data_science/python_chart_styling.htm)*
...
*Source: [https://www.tutorialspoint.com/python_data_science/python_box_plots.htm](https://www.tutorialspoint.com/python_data_science/python_box_plots.htm)*

---

---
[Previous](/python_data_science/python_chart_styling.htm)[Quiz](/python_data_science/quiz_on_python_box_plots.htm)[Next](/python_data_science/python_heat_maps.htm)
...
Its
**output**is as follows −![boxplot.png](/python/images/boxplot.png)

---

## 24. Python - Heat Maps

*Source: [https://www.tutorialspoint.com/python_data_science/python_heat_maps.htm](https://www.tutorialspoint.com/python_data_science/python_heat_maps.htm)*

---

---

## 25. Python - Scatter Plots

*Source: [https://www.tutorialspoint.com/python_data_science/python_scatter_plots.htm](https://www.tutorialspoint.com/python_data_science/python_scatter_plots.htm)*

---

---
[Previous](/python_data_science/python_heat_maps.htm)[Quiz](/python_data_science/quiz_on_python_scatter_plots.htm)[Next](/python_data_science/python_bubble_charts.htm)
...
Its
**output**is as follows −![scatterplot.png](/python/images/scatterplot.png)

---

## 26. Python - Bubble Charts

*Source: [https://www.tutorialspoint.com/python_data_science/python_bubble_charts.htm](https://www.tutorialspoint.com/python_data_science/python_bubble_charts.htm)*

---

---
[Previous](/python_data_science/python_scatter_plots.htm)[Quiz](/python_data_science/quiz_on_python_bubble_charts.htm)[Next](/python_data_science/python_3d_charts.htm)
Bubble charts display data as a cluster of circles. The required data to create bubble chart needs to have the xy coordinates, size of the bubble and the colour of the bubbles. The colours can be supplied by the 
library itself.
...
Its
**output**is as follows −![bubblechart.png](/python/images/bubblechart.png)

---

## 27. Python - 3D Charts

*Source: [https://www.tutorialspoint.com/python_data_science/python_3d_charts.htm](https://www.tutorialspoint.com/python_data_science/python_3d_charts.htm)*

---

---
[Previous](/python_data_science/python_bubble_charts.htm)[Quiz](/python_data_science/quiz_on_python_3d_charts.htm)[Next](/python_data_science/python_time_series.htm)
...
Its
**output**is as follows −![3dplot.png](/python/images/3dplot.png)

---

## 28. Python - Time Series

*Source: [https://www.tutorialspoint.com/python_data_science/python_time_series.htm](https://www.tutorialspoint.com/python_data_science/python_time_series.htm)*

---

---
[Previous](/python_data_science/python_3d_charts.htm)[Quiz](/python_data_science/quiz_on_python_time_series.htm)[Next](/python_data_science/python_geographical_data.htm)
Time series is a series of data points in which each data point is associated with a timestamp. A simple example is the price of a stock in the stock market at different points of time on a given day.
...
Its
**output**is as follows −![timeseries.png](/python/images/timeseries.png)

---

## 29. Python - Geographical Data

*Source: [https://www.tutorialspoint.com/python_data_science/python_geographical_data.htm](https://www.tutorialspoint.com/python_data_science/python_geographical_data.htm)*

---

---
[Previous](/python_data_science/python_time_series.htm)[Quiz](/python_data_science/quiz_on_python_geographical_data.htm)[Next](/python_data_science/python_graph_data.htm)
...
One such package is Cartopy. You can download and install this package in your local environment from
...
Its
**output**is as follows −![geographic.png](/python/images/geographic.png)

---

## 30. Python - Graph Data

*Source: [https://www.tutorialspoint.com/python_data_science/python_graph_data.htm](https://www.tutorialspoint.com/python_data_science/python_graph_data.htm)*

---

---
[Previous](/python_data_science/python_geographical_data.htm)[Quiz](/python_data_science/quiz_on_python_graph_data.htm)[Next](/python_data_science/python_measuring_central_tendency.htm)
CSGraph stands for
...
## 31. Python - Measuring Central Tendency

*Source: [https://www.tutorialspoint.com/python_data_science/python_measuring_central_tendency.htm](https://www.tutorialspoint.com/python_data_science/python_measuring_central_tendency.htm)*

---

---
[Previous](/python_data_science/python_graph_data.htm)[Quiz](/python_data_science/quiz_on_python_measuring_central_tendency.htm)[Next](/python_data_science/python_measuring_variance.htm)
...
## 32. Python - Measuring Variance

*Source: [https://www.tutorialspoint.com/python_data_science/python_measuring_variance.htm](https://www.tutorialspoint.com/python_data_science/python_measuring_variance.htm)*

---

---

## 33. Python - Normal Distribution

*Source: [https://www.tutorialspoint.com/python_data_science/python_normal_distribution.htm](https://www.tutorialspoint.com/python_data_science/python_normal_distribution.htm)*

---

---
[Previous](/python_data_science/python_measuring_variance.htm)[Quiz](/python_data_science/quiz_on_python_normal_distribution.htm)[Next](/python_data_science/python_binomial_distribution.htm)
...
Its
**output**is as follows −![normdist.png](/python/images/normdist.png)

---

## 34. Python - Binomial Distribution

*Source: [https://www.tutorialspoint.com/python_data_science/python_binomial_distribution.htm](https://www.tutorialspoint.com/python_data_science/python_binomial_distribution.htm)*

---

---
[Previous](/python_data_science/python_normal_distribution.htm)[Quiz](/python_data_science/quiz_on_python_binomial_distribution.htm)[Next](/python_data_science/python_poisson_distribution.htm)
...
Its
**output**is as follows −![binomialdist.png](/python/images/binomialdist.png)

---

## 35. Python - Poisson Distribution

*Source: [https://www.tutorialspoint.com/python_data_science/python_poisson_distribution.htm](https://www.tutorialspoint.com/python_data_science/python_poisson_distribution.htm)*

---

---
[Previous](/python_data_science/python_binomial_distribution.htm)[Quiz](/python_data_science/quiz_on_python_poisson_distribution.htm)[Next](/python_data_science/python_bernoulli_distribution.htm)
...
Its
**output**is as follows −![poissondist.png.png](/python/images/poissondist.png)

---

## 36. Python - Bernoulli Distribution

*Source: [https://www.tutorialspoint.com/python_data_science/python_bernoulli_distribution.htm](https://www.tutorialspoint.com/python_data_science/python_bernoulli_distribution.htm)*

---

---
[Previous](/python_data_science/python_poisson_distribution.htm)[Quiz](/python_data_science/quiz_on_python_bernoulli_distribution.htm)[Next](/python_data_science/python_p_value.htm)
...
Its
**output**is as follows −![bernoulli.png](/python/images/bernoulli.png)

---

## 37. Python - P-Value

*Source: [https://www.tutorialspoint.com/python_data_science/python_p_value.htm](https://www.tutorialspoint.com/python_data_science/python_p_value.htm)*

---

---
[Previous](/python_data_science/python_bernoulli_distribution.htm)[Quiz](/python_data_science/quiz_on_python_p_value.htm)[Next](/python_data_science/python_correlation.htm)
...
You can test the same with a new array of the same length, but with a varied mean. Use a different value in
**loc**and test the same.

---

## 38. Python - Correlation

*Source: [https://www.tutorialspoint.com/python_data_science/python_correlation.htm](https://www.tutorialspoint.com/python_data_science/python_correlation.htm)*

---

---
[Previous](/python_data_science/python_p_value.htm)[Quiz](/python_data_science/quiz_on_python_correlation.htm)[Next](/python_data_science/python_chi_square_test.htm)
...
Its
**output**is as follows −![corelation.png](/python/images/corelation.png)

---

## 39. Python - Chi-Square Test

*Source: [https://www.tutorialspoint.com/python_data_science/python_chi_square_test.htm](https://www.tutorialspoint.com/python_data_science/python_chi_square_test.htm)*

---

---
[Previous](/python_data_science/python_correlation.htm)[Quiz](/python_data_science/quiz_on_python_chi_square_test.htm)[Next](/python_data_science/python_linear_regression.htm)
...
Its
**output**is as follows −![chisquare.png](/python/images/chisquare.png)

---

## 40. Python - Linear Regression

*Source: [https://www.tutorialspoint.com/python_data_science/python_linear_regression.htm](https://www.tutorialspoint.com/python_data_science/python_linear_regression.htm)*

---

---
[Previous](/python_data_science/python_chi_square_test.htm)[Quiz](/python_data_science/quiz_on_python_linear_regression.htm)[Next](/python_data_science/index.htm)
...
Its
**output**is as follows −![lregression.png](/python/images/lregression.png)
